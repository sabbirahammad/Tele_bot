STRINGS = {
    ...
    "en": {
        ...
        "referral_stats_message": "👥 **Referral System**\n\n🔗 **Your Referral Link:**\n`{referral_link}`\n\n📊 **Total Referrals:** {total_referrals} users\n\n{referral_policy_text}\n\nShare the link with friends to earn unlimited!",
